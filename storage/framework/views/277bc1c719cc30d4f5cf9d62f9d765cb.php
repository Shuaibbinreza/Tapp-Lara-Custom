                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="p-2 mt-4">
                                        <div class="text-muted text-center mb-4 mx-lg-3">
                                            ...
                                            <p><?php echo e(__('Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.')); ?></p>
                                        </div>
                                        ...
                                        <div class="mt-3 d-flex items-center justify-content-between w-100">
											<form class="d-inline" method="POST" action="<?php echo e(route('verification.send')); ?>">
												<?php echo csrf_field(); ?>
												<button type="submit" class="btn btn-success w-100"><?php echo e(__('Resend Verification Email')); ?></button>
											</form>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sayeed-tappware/Tappware/TEMPLATE/Velzon_v4.1.0/Laravel/master/resources/views/auth/verify.blade.php ENDPATH**/ ?>